        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">เพิ่มประเภทของผู้ใช้งาน</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="./"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="./">หน้าแรก</a></li>
                            <li class="breadcrumb-item active" aria-current="page">เพิ่มประเภทของผู้ใช้งาน</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card border-0">
                <div class="table-responsive py-4 px-4">
                    ...
                    <form action="./php/action-add-role-user.php" method="POST" enctype="multipart/form-data">
                        <div class="row">

                            <div class="col-md-4">
                                <label for="role_title" class="required">ประเภทผู้ใช้งานใหม่ที่ต้องการเพิ่ม</label>
                                <input type="text" id="role_title" name="role_title" class="form-control" placeholder="ใส่ชื่อประเภทของผู้ใช้งาน" oninput="check_name_role()" required>
